...
function CustomerLoginForm() {
  ...
  return (
    <div className="bg-white/[0.04] border border-white/10 rounded-3xl p-8">
      ...
      <p className="text-[14px] text-white/40 text-center mb-6 leading-relaxed">
        Sign in with Google to view your parking assignment, location, and history.
      </p>

      {error && (
        <div className="mb-6 p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-400 text-[13px] flex items-start gap-3">
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <Suspense fallback={<div className="h-64 rounded-3xl bg-white/[0.04] animate-pulse" />}>
          <CustomerLoginForm />
        </Suspense>
