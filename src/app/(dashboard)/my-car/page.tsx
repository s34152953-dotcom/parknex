      ...
      <div className="max-w-[1240px] w-full mx-auto">
        ...
        {session ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            ...
            <div className="bg-white border border-[rgba(80,60,40,0.10)] rounded-2xl p-7 sm:p-8 relative flex flex-col justify-between shadow-[0_6px_24px_rgba(80,50,20,0.035)]">
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-[12px] px-3 py-1 rounded-full bg-[#10B981]/10 border border-[#10B981]/20 text-[#10B981] font-semibold">
                    {session.status || "Parked Securely"}
                  </span>
                </div>

                {/* Large Location Grid */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 p-4 sm:p-5 rounded-xl bg-[#FAF7F2] border border-[#EAE3D9] mb-6 min-w-0">
                  <div className="min-w-0">
                    <p className="text-[11px] text-[#A8A29E] font-bold uppercase tracking-wider">Floor</p>
                    <p className="text-[22px] font-extrabold text-[#1C1917] mt-0.5 truncate">{session.floor}</p>
                  </div>
                  <div className="min-w-0">
                    <p className="text-[11px] text-[#A8A29E] font-bold uppercase tracking-wider">Zone</p>
                    <p className="text-[22px] font-extrabold text-[#1C1917] mt-0.5 truncate">{session.zone}</p>
                  </div>
                  <div className="min-w-0">
                    <p className="text-[11px] text-[#A8A29E] font-bold uppercase tracking-wider">Pillar</p>
                    <p className="text-[22px] font-extrabold text-[#1C1917] mt-0.5 truncate">{session.pillar}</p>
                  </div>
                  <div className="min-w-0">
                    <p className="text-[11px] text-[#A8A29E] font-bold uppercase tracking-wider">Slot</p>
                    <p className="text-[22px] font-extrabold text-[#D84A2B] mt-0.5 truncate">{session.slot}</p>
                  </div>
                </div>

                {/* Timings */}
                <div className="flex items-center justify-between text-[13px] text-[#78716C] border-t border-[#EAE3D9] pt-4 mb-6">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <Link
                  href="/find-my-car"
                  className="h-12 px-6 rounded-lg bg-[#D84A2B] text-white text-[13.5px] font-semibold inline-flex items-center justify-center gap-2 hover:bg-[#C23E21] active:scale-95 transition-all shadow-sm shadow-[#D84A2B]/20 shrink-0"
                >
                ...
                <Link
                  href="/checkout"
                  className="h-12 px-6 rounded-lg bg-white border border-[#E2D9CC] text-[#1C1917] text-[13.5px] font-semibold inline-flex items-center justify-center gap-2 hover:border-[#D84A2B]/40 hover:bg-[#FFFDFC] active:scale-95 transition-all shadow-xs shrink-0"
                >
            ...
            <div className="bg-white border border-[rgba(80,60,40,0.10)] rounded-2xl p-7 sm:p-8 flex flex-col justify-between shadow-[0_6px_24px_rgba(80,50,20,0.035)]">
              <div>
              ...
              <div className="pt-6 border-t border-[#EAE3D9] mt-6">
                <Link
                  href="/exit-pass"
                  className="w-full h-12 rounded-lg bg-white border border-[#E2D9CC] text-[13.5px] font-semibold text-[#1C1917] inline-flex items-center justify-center gap-2 hover:border-[#D84A2B]/40 hover:bg-[#FFFDFC] transition-colors shadow-xs"
                >
