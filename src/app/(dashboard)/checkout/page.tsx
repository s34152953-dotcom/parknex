        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-6">
            ...
            <div className="bg-white border border-[rgba(80,60,40,0.08)] rounded-3xl p-7 sm:p-9 shadow-[0_8px_32px_rgba(80,50,20,0.03)]">
              <h2 className="text-[19px] font-bold text-[#1C1917] mb-5">
                Session Summary
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4.5 p-5.5 rounded-2xl bg-[#FAF7F2] border border-[#EAE3D9] text-[13.5px]">
                <div>
                  <p className="text-[#A8A29E] text-[11px] font-bold uppercase tracking-wider">Vehicle</p>
                  <p className="text-[#1C1917] font-bold mt-1 text-[15.5px]">Porsche Taycan 4S</p>
                  <p className="text-[12.5px] text-[#78716C] font-mono">KA-01-MJ-2024</p>
                </div>
                <div>
                  <p className="text-[#A8A29E] text-[11px] font-bold uppercase tracking-wider">Location</p>
                  <p className="text-[#1C1917] font-bold mt-1 text-[15.5px]">Floor B2 · Zone A</p>
                  <p className="text-[12.5px] text-[#D84A2B] font-semibold">Slot A-14 (Pillar 18)</p>
                </div>
                <div>
                  <p className="text-[#A8A29E] text-[11px] font-bold uppercase tracking-wider">Duration</p>
                  <p className="text-[#1C1917] font-bold mt-1 text-[15.5px]">1 hr 24 min</p>
                  <p className="text-[12.5px] text-[#78716C]">Billed: 2 hrs</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-[rgba(80,60,40,0.08)] rounded-3xl p-7 sm:p-9 shadow-[0_8px_32px_rgba(80,50,20,0.03)]">
              <div className="flex items-center justify-between mb-5">
                <h2 className="text-[19px] font-bold text-[#1C1917] flex items-center gap-2">
                  <Gift className="w-5 h-5 text-[#D84A2B]" />
                  Available Rewards & Discounts
                </h2>
                <span className="text-[12px] text-[#10B981] font-bold px-3.5 py-1.5 rounded-full bg-[#10B981]/10 border border-[#10B981]/20">1 Applied</span>
              </div>

              <div className="flex flex-col gap-3.5">
                <div
                  onClick={() => setSelectedReward(selectedReward === "reward-1" ? null : "reward-1")}
                  className={`p-5 sm:p-6 rounded-2xl border cursor-pointer transition-all flex items-center justify-between gap-4 ${
                ...
                >
                  <div>
                    <p className="text-[15.5px] font-bold text-[#1C1917]">Mall Dining Voucher</p>
                    <p className="text-[13px] text-[#78716C] mt-1">
                      $20 OFF parking on food court orders above $50
                    </p>
                  </div>
                  <div
                    className={`w-7 h-7 rounded-xl border flex items-center justify-center shrink-0 transition-colors ${
                      selectedReward === "reward-1"
          ...
          <div className="lg:col-span-5 xl:col-span-4 bg-white border border-[rgba(80,60,40,0.08)] rounded-3xl p-7 sm:p-9 shadow-[0_8px_32px_rgba(80,50,20,0.03)] flex flex-col justify-between">
            <div>
              <h2 className="text-[19px] font-bold text-[#1C1917] mb-5">Tariff Breakdown</h2>
              ...
              <div className="flex items-center justify-between text-[16px] font-bold text-[#1C1917] mb-6">
                ...
                <span className="text-[28px] sm:text-[30px] font-extrabold text-[#D84A2B]">
            ...
            <div className="flex flex-col gap-3.5 pt-4">
              <button
                ...
                className="w-full min-h-[52px] rounded-xl bg-[#D84A2B] text-white text-[15px] font-semibold flex items-center justify-center gap-2 hover:bg-[#C23E21] active:scale-[0.98] transition-all shadow-md shadow-[#D84A2B]/20 cursor-pointer"
              >
                {isProcessing ? (
                  "Authorizing Pass..."
                ) : (
