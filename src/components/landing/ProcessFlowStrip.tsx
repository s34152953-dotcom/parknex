...
export default function ProcessFlowStrip() {
  return (
    <section className="relative z-20 w-full bg-[#000000] border-t border-[#333333] py-5 px-8 sm:px-12 lg:px-16 overflow-x-auto scrollbar-none">
        ...
        {steps.map((step, idx) => (
          <div key={step.label} className="flex items-center gap-3 shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-md bg-[#111111] border border-[#333333] flex items-center justify-center text-white">
                <step.icon className="w-4 h-4 text-[#00E5FF]" strokeWidth={1.5} />
              </div>
