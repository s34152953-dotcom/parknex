    ...
    const initialBookings: BookingRecord[] = [
      {
        ...
        exitTime: null,
        status: "ACTIVE",
        qrToken: "exit_token_demo_a01_secure",
        customerAccessToken: "cust_token_demo_a01",
        smsStatus: "SENT",
        smsMessageId: "msg_init_01",
        createdAt: new Date(Date.now() - 45 * 60 * 1000).toISOString(),
        completedAt: null,
      },
      {
        id: "bk-init-2",
        bookingNumber: "PKX-10295",
        ...
        entryTime: new Date(Date.now() - 85 * 60 * 1000).toISOString(),
        exitTime: null,
        status: "ACTIVE",
        qrToken: "exit_token_demo_a02_secure",
        customerAccessToken: "cust_token_demo_a02",
        smsStatus: "SENT",
        smsMessageId: "msg_init_02",
        createdAt: new Date(Date.now() - 85 * 60 * 1000).toISOString(),
        completedAt: null,
      },
      {
        id: "bk-init-3",
        bookingNumber: "PKX-10280",
        vehicleNumber: "DL 03 CX 8899",
        phoneNumber: "+91 99110 88990",
        mallId: "cm-grand",
        mallName: "Central Mall Grand",
        floor: "B2",
        zone: "Zone A",
        ...
        entryTime: new Date(Date.now() - 140 * 60 * 1000).toISOString(),
        exitTime: new Date(Date.now() - 15 * 60 * 1000).toISOString(),
        status: "COMPLETED",
        qrToken: "exit_token_demo_a03_used",
        customerAccessToken: "cust_token_demo_a03",
        smsStatus: "SENT",
        smsMessageId: "msg_init_03",
